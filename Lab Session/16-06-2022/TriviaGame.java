...
public class TriviaGame {
	...
	public static int triviaMethod(String[] questions, String[] stt) {
		...
		for(int i=0;i<5;i++) {
			...
			if(stt[i].toUpperCase().equals(answers[i])) {	//converting to uppercase & comparing with answers
	...
	public static void main(String[] args) {
		...
		point=triviaMethod(questions,stt);		//calling trivialMethod and storing in point
		System.out.println("Final score: "+point);
		
		//for declaring rewards according to score
		if(point==15) {
